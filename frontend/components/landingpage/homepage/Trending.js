...
export default function Trending({ image, title, price, discount, wishlist }) {
  ...
  return (
    <div className="bg-secondary-black h-full min-w-40 md:min-w-48 border border-primary-gray shadow-md overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex flex-col items-end">
          ...
          <span className="text-md md:text-lg font-bold text-primary-blue">
